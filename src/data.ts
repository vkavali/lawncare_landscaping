...
export const tabs: { id: TabId; label: LocalizedText; icon: string }[] = [
  { id: 'demo', label: lt('Demo', 'Demo'), icon: 'play-circle' },
  { id: 'hoy', label: lt('Today', 'Hoy'), icon: 'home' },
  { id: 'agenda', label: lt('Schedule', 'Agenda'), icon: 'calendar' },
  { id: 'trabajos', label: lt('Jobs', 'Trabajos'), icon: 'clipboard' },
...
export const calendarDays: CalendarDay[] = [
  {
    id: 'lun-26',
    shortLabel: lt('Mon', 'Lun'),
    dayLabel: lt('Monday', 'Lunes'),
    dateLabel: lt('Jun 26', '26 Jun'),
    jobs: 8,
    crewsBusy: 3,
    weather: lt('Cloudy', 'Nublado'),
  },
  {
    id: 'mar-27',
    shortLabel: lt('Tue', 'Mar'),
    dayLabel: lt('Tuesday', 'Martes'),
    dateLabel: lt('Jun 27', '27 Jun'),
    jobs: 6,
    crewsBusy: 3,
    weather: lt('PM rain', 'Lluvia PM'),
  },
  {
    id: 'mie-28',
    shortLabel: lt('Wed', 'Mie'),
    dayLabel: lt('Wednesday', 'Miercoles'),
    dateLabel: lt('Jun 28', '28 Jun'),
    jobs: 7,
    crewsBusy: 2,
    weather: lt('Sunny', 'Sol'),
  },
  {
    id: 'jue-29',
    shortLabel: lt('Thu', 'Jue'),
    dayLabel: lt('Thursday', 'Jueves'),
    dateLabel: lt('Jun 29', '29 Jun'),
    jobs: 5,
    crewsBusy: 2,
    weather: lt('Sunny', 'Sol'),
  },
  {
    id: 'vie-30',
    shortLabel: lt('Fri', 'Vie'),
    dayLabel: lt('Friday', 'Viernes'),
    dateLabel: lt('Jun 30', '30 Jun'),
    jobs: 9,
    crewsBusy: 3,
    weather: lt('Heat', 'Calor'),
  },
  {
    id: 'sab-01',
    shortLabel: lt('Sat', 'Sab'),
    dayLabel: lt('Saturday', 'Sabado'),
    dateLabel: lt('Jul 01', '01 Jul'),
    jobs: 4,
    crewsBusy: 2,
    weather: lt('Sunny', 'Sol'),
  },
...
export const trackingPings: TrackingPing[] = [
  {
    crewId: 'norte',
    location: 'Cumbres 2do Sector',
    updatedAt: lt('3 min ago', 'Hace 3 min'),
    eta: lt('14 min to next stop', '14 min a siguiente parada'),
    completedStops: 2,
    totalStops: 4,
    speed: '28 km/h',
    status: 'normal',
  ...
  {
    crewId: 'centro',
    location: 'San Jeronimo',
    updatedAt: lt('1 min ago', 'Hace 1 min'),
    eta: lt('On site', 'En sitio'),
    completedStops: 1,
    totalStops: 3,
    speed: '0 km/h',
    status: 'normal',
  ...
  {
    crewId: 'oriente',
    location: 'Apodaca Centro',
    updatedAt: lt('6 min ago', 'Hace 6 min'),
    eta: lt('22 min late', '22 min de retraso'),
    completedStops: 1,
    totalStops: 3,
    speed: '19 km/h',
    status: 'retraso',
...
export const quickTemplates = {
  reminder: lt(
    'Hi, sending over a payment reminder and today’s service proof. As soon as it clears I will send confirmation.',
    'Hola, te comparto recordatorio de pago y evidencia del servicio de hoy. En cuanto quede aplicado te envio confirmacion.',
  ),
  followUp: lt(
    'Hi, I’m sending over the proposal and I’m available to schedule the visit or start date.',
    'Hola, te comparto la propuesta y quedo atento para agendar visita o arranque.',
  ),
  referral: lt(
    'Thanks for your trust. If you know someone in your neighborhood who needs lawn care, I can build a referral rate.',
    'Gracias por tu confianza. Si conoces a alguien en tu colonia que necesite jardineria, te puedo armar tarifa de referencia.',
  ),
}

export const checklistLabels: Record<TaskKey, LocalizedText> = {
  llegada: lt('Arrival confirmed', 'Llegada confirmada'),
  fotoAntes: lt('Before photos', 'Fotos antes'),
  trabajo: lt('Work completed', 'Trabajo completado'),
  fotoDespues: lt('After photos', 'Fotos despues'),
  cobro: lt('Payment confirmed', 'Cobro confirmado'),
}
